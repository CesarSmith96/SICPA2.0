...
<html lang="en">
	...
	<table border=\"1\" align=\"center\">
		<font size='6' color='#084B8A'><center>REPORTE NOTAS DE CREDITO RECIBIDAS</center><font size='5' color=\"#ffffff\">
			...
			@if(sizeof($comprobantes)>0)
				...
				@foreach ($comprobantes as $comprobante)
					<tr>
						...
						<td  align='center'><strong>{{$comprobante->tipocomprobanteinc->tcompinc_desc}}</strong></td>
...
<?php
	...
	header("Content-Disposition: attachment; filename=ReporteNCrecibida.xls");  
