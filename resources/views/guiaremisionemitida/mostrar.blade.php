			...
			<ul class="fab-menu-inner">
				<li>
					<div data-fab-label="Agregar">
						<a href="/validado/guiaremisionemitida/crear" class="btn btn-light rounded-round btn-icon btn-float bg-teal-400">
				...
				<li>
					<div data-fab-label="exportar">
						<form class="form-inline" role="form" method="POST" action="/validado/guiaremisionemitida">
	...
	<div class="col-md-9 col-centered">
		<div class="card border-success-400">
			<div class="card-header header-elements-inline bg-dark">
					<h6 class="card-title">Guías de Remisión</h6>
