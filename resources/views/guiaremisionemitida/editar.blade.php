				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/guiaremisionemitida/crear">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Nro</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="comp_ref" id="comp_ref"  value="{{$comprobante->comp_ref}}">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="date" class="form-control text-uppercase" name="comp_fecha"  value="{{$comprobante_ref->comp_fecha}}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="uni_id">
									@foreach ($unidades as $unidad)
									   	@if($unidad->uni_id == $comprobante->adicionalguia->uni_id)
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="mtras_id">
									@foreach ($motivotraslados as $motivotraslado)
									   @if($motivotraslado->mtras_id == $comprobante->adicionalguia->mtras_id)
											<option selected value='{{$motivotraslado->mtras_id}}'>{{$motivotraslado->mtras_desc}}</option>
										@else
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								@else
								<input type="radio" class="radio-inline" name="adig_transprog" value="SI">Sí
								<input type="radio" checked="checked" class="radio-inline" name="adig_transprog" value="NO">No
								@endif
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_pbruto" value="{{ $comprobante->adicionalguia->adig_pbruto }}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Nro. de Bultos</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_nbulto" value="{{ $comprobante->adicionalguia->adig_nbulto }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="adig_mtrasl">
										@if($comprobante->adicionalguia->adig_mtrasl=="TRANSPORTE PUBLICO")
										   <option selected="">TRANSPORTE PUBLICO</option>
										   <option>TRANSPORTE PRIVADO</option>
										@else
											<option>TRANSPORTE PUBLICO</option>
											<option selected="">TRANSPORTE PRIVADO</option>
										@endif
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="date" class="form-control text-uppercase" name="adig_ftrasl"  value="{{ $comprobante->adicionalguia->adig_ftrasl }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="adig_tdoctrans">
									@if($comprobante->adicionalguia->adig_tdoctrans=="DNI")
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_doctrans" value="{{ $comprobante->adicionalguia->adig_doctrans }}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Razón Social</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_rztrans" value="{{ $comprobante->adicionalguia->adig_rztrans }}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Nro. Placa Vehículo</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_nroplaca" value="{{ $comprobante->adicionalguia->adig_nroplaca }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="adig_tdoccond">
									@if($comprobante->adicionalguia->adig_tdoccond=="DNI")
									   <option selected="">DNI</option>
									   <option>RUC</option>
									@else
										<option>DNI</option>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_doccond" value="{{ $comprobante->adicionalguia->adig_doccond }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="dpto_idpart" id="dpto_idpart" onchange="getProvinciapart(this)">
									@foreach ($departamentos as $departamento)
										@if($departamento->dpto_id==$comprobante->adicionalguia->dpto_idpart)
									   		<option  selected="" value='{{$departamento->dpto_id}}'>{{$departamento->dpto_desc}}</option>
									   	@else
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="prov_idpart" id="prov_idpart" onchange="getDistritopart(this)">
									<option value="{{$comprobante->adicionalguia->prov_idpart}}">{{$comprobante->adicionalguia->provinciapart->prov_desc}}</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="dist_idpart" id="dist_idpart">
									<option value="{{$comprobante->adicionalguia->dist_idpart}}">{{$comprobante->adicionalguia->distritopart->dist_desc}}</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_dirpart" value="{{ $comprobante->adicionalguia->adig_dirpart }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="dpto_idlleg" id="dpto_idlleg" onchange="getProvincialleg(this)">
									@foreach ($departamentos as $departamento)
										@if($departamento->dpto_id==$comprobante->adicionalguia->dpto_idlleg)
									   		<option  selected="" value='{{$departamento->dpto_id}}'>{{$departamento->dpto_desc}}</option>
									   	@else
									   		<option  value='{{$departamento->dpto_id}}'>{{$departamento->dpto_desc}}</option>
									   	@endif
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="prov_idlleg" id="prov_idlleg" onchange="getDistritolleg(this)">
									<option value="{{$comprobante->adicionalguia->prov_idlleg}}">{{$comprobante->adicionalguia->provincialleg->prov_desc}}</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control text-uppercase" name="dist_idlleg" id="dist_idlleg">
									<option value="{{$comprobante->adicionalguia->dist_idlleg}}">{{$comprobante->adicionalguia->distritolleg->dist_desc}}</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_dirlleg" value="{{ $comprobante->adicionalguia->adig_dirlleg }}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Nro. Contenedor</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_ncontenedor" value="{{ $comprobante->adicionalguia->adig_ncontenedor }}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Código de Puerto</label>
							<div class="col-md-6">
								<input type="text" class="form-control text-uppercase" name="adig_codpuerto" value="{{ $comprobante->adicionalguia->adig_codpuerto }}">
							</div>
						</div>
