<script type="text/javascript">
	function regresar()
	{
		window.location.href="/validado/detallenotacreditoemitida/regresar?comp_id={{$comprobante->comp_id}}" ;
	}
</script>
...
//ponemos tipo "a' para añadir lineas sin borrar
	...
	$tipodocincluido = $comprobante->tipocomprobanteinc->tcompinc_cod;
	...
	$cabecera=$doc_corre."|".$tipocomp."|".$tipodocincluido."|".$rucemisor."|".$comprobante->entidad->ent_ruc."|".$fechaemision."|".$fechavenc."|".$moneda."|".number_format($comprobante->comp_subt,2,'.','')."|".$comprobante->comp_desc."|".$totalbase."|"."0.00"."|".$comprobante->comp_igv."|"."0.00"."|"."0.00"."|".number_format($comprobante->comp_tot,2,'.','')."|"."1"."|".$tipodocref."|".$nrodocref."|".$nro_serie."|".$nro_doc."|".$usuarioid."|".$comprobante->comp_id."|".""."|".$tipodoc_iden."|"."01"."|"."NO"."|".""."|".""."|".$trans_gratuita."|".$desc_global."|"."00"."|"."00"."|"."00"."|";
	...
	$cabecera="C"."|".$comprobante->entidad->ent_ruc."|".$comprobante->entidad->ent_rz."|".$comprobante->entidad->ent_dir."|".$comprobante->entidad->ent_tel."|".$comprobante->entidad->ent_correo."|"."PE"."|".$comprobante->entidad->ent_dpto."|".$comprobante->entidad->ent_ciu."|".$comprobante->entidad->ent_cont."|".$comprobante->entidad->ent_rz."|".$tipodoc_iden."|";
