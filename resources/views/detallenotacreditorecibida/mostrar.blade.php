...
<div class="container-fluid">
	...
	<div class="col-md-8 col-md-offset-2">
				...
				@if(sizeof($detallecomprobantes)>0)
					...
					@foreach ($detallecomprobantes as $detallecomprobante)
						<tr>
							...
							<td>
							<a id="eliminar" href="/validado/detallenotacreditorecibida/eliminar?dcomp_id={{$detallecomprobante->dcomp_id}}" onclick="return confirm('Esta seguro que desea eliminar?')" class="btn btn-danger">Eliminar</a></td>
						</tr>
					@endforeach
		...
		<a href="/validado/detallenotacreditorecibida/generartxt?comp_id={{$comprobante->comp_id}}" class="btn btn-info" role="button">Generar Txt</a>
		<a style="float: right;" href="/validado/notacreditorecibida" class="btn btn-danger" role="button">Regresar</a>
