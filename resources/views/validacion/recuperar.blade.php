		...
		<div class="col-md-5 col-centered">
			<div class="card border-success-400">
				<div class="card-header header-elements-inline bg-dark">
					<h6 class="card-title">Recuperar Contraseña</h6>
				...
				<button type="submit" class="btn btn-outline bg-white text-white border-white border-2">Recuperar Contraseña<i class="icon-paperplane ml-2"></i></button>
				</div>
			</form>
			</div>
		</div>
