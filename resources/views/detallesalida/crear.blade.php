				...
				<div class="card-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/detallesalida/crear">
						...
						<div class="form-group">
							...
							<div>
								<input type="text" class="form-control text-uppercase" name="dcomp_prec" value="0.00">
							</div>
						</div>
				</div>
				<div class="card-footer d-flex justify-content-between align-items-center bg-dark border-top-0">
					<a href="/validado/detallesalida?comp_id={{$comp_id}}" class="btn bg-transparent text-white border-white border-2">Cancelar</a>
