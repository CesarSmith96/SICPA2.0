		...
		<div class="col-md-8 col-centered">
			<div class="card border-success-400">
				...
				<div class="card-body border-success-400">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/detallenotacreditoemitida/editar">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								...
								<a href="/validado/detallenotacreditoemitida?comp_id={{$detallecomprobante->comp_id}}" class="btn btn-danger" role="button">Cancelar</a>
							</div>
						</div>
				</div>
				<div class="card-footer d-flex justify-content-between align-items-center bg-dark border-top-0">
				<a href="/validado/detallenotacreditoemitida?comp_id={{$detallecomprobante->comp_id}}" class="btn bg-transparent text-white border-white border-2">Cancelar</a>
