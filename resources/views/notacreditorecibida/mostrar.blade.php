...
<div class="container-fluid">
	<div class="col-md-12 col-md-offset-0">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-inline" role="form" method="POST" action="/validado/notacreditorecibida" style="font-size: 11px">
	...
	<div class="col-md-12 col-md-offset-0">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<a href="/validado/notacreditorecibida/crear" class="btn btn-success" role="button">Nueva Nota de Crédito</a>
				<br/><br/>
				<table class="table">
						<tr>
							<th>Nro.</th>
