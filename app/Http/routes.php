...
Route::get('/information/create/ajaxnotapedido',function()
{
    $comp_np = Input::get('comp_np');

    if(Comprobante::where('comp_np',$comp_np)->count()>0)
        return "Ya existe";
...
Route::controllers([
    ...
    'validado/detallenotacreditorecibida'=>'DetalleNotaCreditoRecibidaController',
	'validado/notacredito'=>'NotaCreditoController',
    'validado/notacreditoemitida'=>'NotaCreditoEmitidaController',
    'validado/notacreditorecibida'=>'NotaCreditoRecibidaController',
    ...
    'validado/tipocc'=>'TipoCCController',
